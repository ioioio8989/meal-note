'use strict';
const CACHE='meal-note-shell-v20-4';
const FILES=['./index.html','./app.js','./storage.js','./upgrade.js','./upgrade.css','./meals.js','./experience.js','./experience.css','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
